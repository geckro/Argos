...
public class LuiafkAdditions : GlobalItem
{
    public override void AddRecipes()
    {
        ...
        AddRecipe(unlBoneArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.BoneArrow, 9999)],
                [TileID.BoneWelder]);
        AddRecipe(unlChloroArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.ChlorophyteArrow, 9999)],
                [TileID.Autohammer]);
        AddRecipe(unlCursedArrows.Type, [Ingredient(unlUnholyArrows.Type), Ingredient(ItemID.CursedArrow, 9999)],
                [TileID.DemonAltar]);
        AddRecipe(unlFlamingArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.FlamingArrow, 9999)],
                [TileID.Hellforge]);
        AddRecipe(unlFrostburnArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.FrostburnArrow, 9999)],
                [TileID.IceMachine]);
        AddRecipe(unlHellfireArrows.Type, [Ingredient(unlFlamingArrows.Type), Ingredient(ItemID.HellfireArrow, 9999)],
                [TileID.Hellforge]);
        AddRecipe(unlHolyArrows.Type, [Ingredient(unlJesterArrows.Type), Ingredient(ItemID.HolyArrow, 9999)],
                [TileID.SkyMill]);
        AddRecipe(unlIchorArrows.Type, [Ingredient(unlUnholyArrows.Type), Ingredient(ItemID.IchorArrow, 9999)],
                [TileID.DemonAltar]);
        AddRecipe(unlJesterArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.JestersArrow, 9999)],
                [TileID.SkyMill]);
        AddRecipe(unlLuminiteArrows.Type, [Ingredient(unlChloroArrows.Type), Ingredient(ItemID.MoonlordArrow, 9999)],
                [TileID.LunarCraftingStation]);
        AddRecipe(unlShimmerArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.ShimmerArrow, 9999)],
                [TileID.CrystalBall], [Condition.InAether]);
        AddRecipe(unlUnholyArrows.Type, [Ingredient(ItemID.EndlessQuiver), Ingredient(ItemID.UnholyArrow, 9999)],
                [TileID.DemonAltar]);
        AddRecipe(unlVenomArrows.Type, [Ingredient(unlChloroArrows.Type), Ingredient(ItemID.VenomArrow, 9999)],
                [TileID.BewitchingTable]);

        AddRecipe(unlChloroBullets.Type,
                [Ingredient(ItemID.EndlessMusketPouch), Ingredient(ItemID.MoonlordBullet, 9999)], [TileID.Autohammer]);
        AddRecipe(unlLuminiteBullets.Type,
                [Ingredient(unlChloroBullets.Type), Ingredient(ItemID.ChlorophyteBullet, 9999)],
                [TileID.LunarCraftingStation]);
        AddRecipe(unlMeteorShot.Type, [Ingredient(ItemID.EndlessMusketPouch), Ingredient(ItemID.MeteorShot, 9999)],
                [TileID.Hellforge]);
