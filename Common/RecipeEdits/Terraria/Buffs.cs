...
public class Food : GlobalItem
{
    ...
    {
        RecipeHelper.AddRecipe(ItemID.CookedFish,
                [(ItemID.Bass, 1), (ItemID.Acorn, 1), (ItemID.Mushroom, 1)], [TileID.CookingPots],
                [Condition.NearWater]);

        RecipeHelper.AddRecipe(ItemID.CookedFish,
                [(ItemID.Trout, 1), (ItemID.ShellPileBlock, 1), (ItemID.Mushroom, 1)],
                [TileID.CookingPots], [Condition.NearWater]);

        RecipeHelper.AddRecipe(ItemID.CookedFish,
                [(ItemID.AtlanticCod, 1), (ItemID.Acorn, 1), (ItemID.Shiverthorn, 1)],
                [TileID.CookingPots], [Condition.NearWater]);
...
public class Flasks : GlobalItem
{
    public override void AddRecipes()
    {
        ...
        RecipeHelper.AddRecipe(ItemID.FlaskofVenom,
                [(ItemID.FlaskofPoison, 1), (ItemID.VialofVenom, 8), (ItemID.Granite, 80)],
...
public class BuffStations : GlobalItem
{
    public override void AddRecipes()
    {
        ...
        RecipeHelper.AddRecipe(ItemID.FrozenCampfire, [(ItemID.IceTorch, 45), (ItemID.BorealWood, 12)], [TileID.IceMachine]);
        RecipeHelper.AddRecipe(ItemID.JungleCampfire, [(ItemID.JungleCampfire, 45), (ItemID.RichMahogany, 12)], [TileID.WorkBenches]);
        RecipeHelper.AddRecipe(ItemID.DesertCampfire, [(ItemID.DesertTorch, 45), (ItemID.PalmWood, 12)], [TileID.GlassKiln]);
        RecipeHelper.AddRecipe(ItemID.MushroomCampfire, [(ItemID.MushroomTorch, 45), (ItemID.GlowingMushroom, 12)], [TileID.WorkBenches]);
        RecipeHelper.AddRecipe(ItemID.CoralCampfire, [(ItemID.CoralTorch, 45), (ItemID.ReefBlock, 12)], [TileID.WorkBenches]);
        RecipeHelper.AddRecipe(ItemID.CorruptCampfire, [(ItemID.CorruptTorch, 45), (ItemID.Ebonwood, 12)], [TileID.DemonAltar]);
        RecipeHelper.AddRecipe(ItemID.CrimsonCampfire, [(ItemID.CrimsonTorch, 45), (ItemID.Shadewood, 12)], [TileID.DemonAltar]);
        RecipeHelper.AddRecipe(ItemID.IchorCampfire, [(ItemID.IchorTorch, 45), (ItemID.SpookyWood, 12)], [TileID.DemonAltar]);
        RecipeHelper.AddRecipe(ItemID.CursedCampfire, [(ItemID.CursedTorch, 45), (ItemID.SpookyWood, 12)], [TileID.DemonAltar]);
        RecipeHelper.AddRecipe(ItemID.BoneCampfire, [(ItemID.BoneTorch, 45), (ItemID.Bone, 12)], [TileID.BoneWelder]);
        RecipeHelper.AddRecipe(ItemID.UltraBrightCampfire, [(ItemID.UltrabrightTorch, 45), (ItemID.DynastyWood, 12)], [TileID.WorkBenches]);
        RecipeHelper.AddRecipe(ItemID.DemonCampfire, [(ItemID.DemonTorch, 45), (ItemID.AshWood, 12)], [TileID.Hellforge]);
        RecipeHelper.AddRecipe(ItemID.ShimmerCampfire, [(ItemID.ShimmerTorch, 45), (ItemID.StoneBlock, 12)], [TileID.CookingPots]);
        RecipeHelper.AddRecipe(ItemID.RainbowCampfire, [(ItemID.RainbowTorch, 45), (ItemID.RainbowBrick, 12)], [TileID.MeatGrinder]);
        RecipeHelper.AddRecipe(ItemID.HallowedCampfire, [(ItemID.HallowedTorch, 45), (ItemID.Pearlwood, 12)], [TileID.MythrilAnvil]);

        RecipeHelper.AddRecipe(ItemID.HeartLantern, [(ItemID.LifeCrystal, 2), (ItemID.CagedLantern, 1)], [TileID.Anvils]);

        RecipeHelper.AddRecipe(ItemID.StarinaBottle, [(ItemID.ManaCrystal, 2), (ItemID.BottledHoney, 1)], [TileID.Anvils]);

        RecipeHelper.AddRecipe(ItemID.PeaceCandle, [(ItemID.PinkTorch, 1), (ItemID.WaterCandle, 1), (ItemID.CalmingPotion, 2), (ItemID.InvisibilityPotion, 1)], [TileID.BoneWelder]);

        // can be gotten pre skele to make some grind easier
        RecipeHelper.AddRecipe(ItemID.WaterCandle, [(ItemID.BlueTorch, 1), (ItemID.Candle, 1), (ItemID.BattlePotion, 2)], [TileID.Sinks, TileID.Anvils]);
    }
}