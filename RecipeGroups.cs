...
public class RecipeGroups : ModSystem
{
    public override void AddRecipeGroups()
    {
        ...
        RegisterGroup(nameof(AdamantiteBreastplate),
                new RG(() => "Any Adamantite or Titanium Breastplate", AdamantiteBreastplate,
                        TitaniumBreastplate));
        ...
        RegisterGroup(nameof(AdamantiteLeggings),
                new RG(() => "Any Adamantite or Titanium Leggings", AdamantiteLeggings,
                        TitaniumLeggings));
        ...
        RegisterGroup(nameof(AdamantiteRepeater),
                new RG(() => "Any Adamantite or Titanium Repeaters", AdamantiteRepeater,
                        TitaniumRepeater));
        ...
        RegisterGroup(nameof(BeetleScaleMail),
                new RG(() => "Any Beetle Breastplate", BeetleScaleMail, BeetleShell));
        RegisterGroup(nameof(CobaltBar),
                new RG(() => "Any Cobalt or Palladium Bars", CobaltBar, PalladiumBar));
        RegisterGroup(nameof(CobaltBreastplate),
                new RG(() => "Any Cobalt or Palladium Breastplate", CobaltBreastplate,
        ...
        RegisterGroup(nameof(CobaltOre),
                new RG(() => "Any Cobalt or Palladium Ores", CobaltOre, PalladiumOre));
        ...
        RegisterGroup(nameof(CobaltSword),
                new RG(() => "Any Cobalt or Palladium Swords", CobaltSword, PalladiumSword));
        ...
        RegisterGroup(nameof(CopperGreaves),
                new RG(() => "Any Copper or Tin Greaves", CopperGreaves, TinGreaves));
        RegisterGroup(nameof(CopperHammer),
                new RG(() => "Any Copper or Tin Hammers", CopperHammer, TinHammer));
        RegisterGroup(nameof(CopperHelmet),
                new RG(() => "Any Copper or Tin Helmet", CopperHelmet, TinHelmet));
        RegisterGroup(nameof(CopperOre), new RG(() => "Any Copper or Tin Ores", CopperOre, TinOre));
        RegisterGroup(nameof(CopperPickaxe),
                new RG(() => "Any Copper or Tin Pickaxes", CopperPickaxe, TinPickaxe));
        ...
        RegisterGroup(nameof(GoldAxe),
                new RG(() => "Any Gold or Platinum Axes", GoldAxe, PlatinumAxe));
        RegisterGroup(nameof(GoldBar),
                new RG(() => "Any Gold or Platinum Bars", GoldBar, PlatinumBar));
        RegisterGroup(nameof(GoldBow),
                new RG(() => "Any Gold or Platinum Bows", GoldBow, PlatinumBow));
        ...
        RegisterGroup(nameof(GoldGreaves),
                new RG(() => "Any Gold or Platinum Greaves", GoldGreaves, PlatinumGreaves));
        RegisterGroup(nameof(GoldHammer),
                new RG(() => "Any Gold or Platinum Hammers", GoldHammer, PlatinumHammer));
        RegisterGroup(nameof(GoldHelmet),
                new RG(() => "Any Gold or Platinum Helmet", GoldHelmet, PlatinumHelmet));
        RegisterGroup(nameof(GoldOre),
                new RG(() => "Any Gold or Platinum Ores", GoldOre, PlatinumOre));
        RegisterGroup(nameof(GoldPickaxe),
                new RG(() => "Any Gold or Platinum Pickaxes", GoldPickaxe, PlatinumPickaxe));
        ...
        RegisterGroup(nameof(IronChainmail),
                new RG(() => "Any Iron or Lead Chainmail", IronChainmail, LeadChainmail));
        RegisterGroup(nameof(IronGreaves),
                new RG(() => "Any Iron or Lead Greaves", IronGreaves, LeadGreaves));
        RegisterGroup(nameof(IronHammer),
                new RG(() => "Any Iron or Lead Hammers", IronHammer, LeadHammer));
        RegisterGroup(nameof(IronHelmet),
                new RG(() => "Any Iron or Lead Helmet", IronHelmet, LeadHelmet));
        RegisterGroup(nameof(IronOre), new RG(() => "Any Iron or Lead Ores", IronOre, LeadOre));
        RegisterGroup(nameof(IronPickaxe),
                new RG(() => "Any Iron or Lead Pickaxes", IronPickaxe, LeadPickaxe));
        RegisterGroup(nameof(IronShortsword),
                new RG(() => "Any Iron or Lead Shortswords", IronShortsword, LeadShortsword));
        RegisterGroup(nameof(LightsBane),
                new RG(() => "Any Evil Swords", LightsBane, BloodButcherer));
        RegisterGroup(nameof(MythrilAnvil),
                new RG(() => "Any Hardmode Anvils", MythrilAnvil, OrichalcumAnvil));
        RegisterGroup(nameof(MythrilBar),
                new RG(() => "Any Mythril or Orichalcum Bars", MythrilBar, OrichalcumBar));
        RegisterGroup(nameof(MythrilChainmail),
                new RG(() => "Any Mythril or Orichalcum Breastplate", MythrilChainmail,
        ...
        RegisterGroup(nameof(MythrilOre),
                new RG(() => "Any Mythril or Orichalcum Ores", MythrilOre, OrichalcumOre));
        ...
        RegisterGroup(nameof(ShadowGreaves),
                new RG(() => "Any Evil Greaves", ShadowGreaves, CrimsonGreaves));
        RegisterGroup(nameof(ShadowHelmet),
                new RG(() => "Any Evil Helmet", ShadowHelmet, CrimsonHelmet));
        RegisterGroup(nameof(ShadowScale),
                new RG(() => "Any Evil Scale", ShadowScale, TissueSample));
        RegisterGroup(nameof(ShadowScalemail),
                new RG(() => "Any Evil Scalemail", ShadowScalemail, CrimsonScalemail));
        RegisterGroup(nameof(ShroomiteHelmet),
                new RG(() => "Any Shroomite Helmet", ShroomiteHelmet, ShroomiteHeadgear, ShroomiteMask));
        RegisterGroup(nameof(SilverAxe),
                new RG(() => "Any Silver or Tungsten Axes", SilverAxe, TungstenAxe));
        RegisterGroup(nameof(SilverBar),
                new RG(() => "Any Silver or Tungsten Bars", SilverBar, TungstenBar));
        RegisterGroup(nameof(SilverBow),
                new RG(() => "Any Silver or Tungsten Bows", SilverBow, TungstenBow));
        ...
        RegisterGroup(nameof(SilverOre),
                new RG(() => "Any Silver or Tungsten Ores", SilverOre, TungstenOre));
        ...
        RegisterGroup(nameof(SpectreMask),
                new RG(() => "Any Spectre Head", SpectreMask, SpectreHood));
        RegisterGroup(nameof(TheBreaker),
                new RG(() => "Any Evil Hammers", TheBreaker, FleshGrinder));
        RegisterGroup(nameof(WarAxeoftheNight),
                new RG(() => "Any Evil Axes", WarAxeoftheNight, BloodLustCluster));
    }
}